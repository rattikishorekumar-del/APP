...
// Separate backend used only by "Know Your Status" (Selections sheet lookup) — kept apart from
// WEB_APP_URL above, which continues to handle login, registration, and job posting.
const STATUS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbzNoK4d2MdtTciXBRHcZ_aE8UIPpIcnWcXIzNBCd8Hxg2EwpEhP1e_Hpu528PHsHs4z/exec';
...
async function searchStatus(){
  ...
  ld('Searching…');
  try {
    const r = await apiGet('getAll', { sheet: 'Selections' }, STATUS_WEB_APP_URL);
    hd();
